...
# Experiment 2: 2D Random Slice Selection
# Dataset: Abdomen MR (702)
# Strategy: Random slice selection (10 slices per volume)

set -e

echo "=========================================="
echo "Experiment 2: 2D Random Slice Selection"
echo "=========================================="
...
LR="0.005"
BS="30"
SLICE_FILE="$BASE_DIR/data/slice_selections/random_slices.json"

# Paths
BASE_DIR="/home/bs_thesis/xlstm_new/xLSTM-UNet-PyTorch"
OUTPUT_DIR="$BASE_DIR/nnUNet_predictions/exp2_2D_random"
...
# Training
echo "Starting training with random slice selection..."
