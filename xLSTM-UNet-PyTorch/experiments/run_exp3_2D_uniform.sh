...
# Experiment 3: 2D Uniform Slice Selection
# Dataset: Abdomen MR (702)
# Strategy: Uniform slice selection (10 slices evenly spaced)

set -e

echo "=========================================="
echo "Experiment 3: 2D Uniform Slice Selection"
echo "=========================================="
...
OUTPUT_DIR="$BASE_DIR/nnUNet_predictions/exp3_2D_uniform"
...
SLICE_FILE="$BASE_DIR/data/slice_selections/uniform_slices.json"
...
# Training
echo "Starting training with uniform slice selection..."
