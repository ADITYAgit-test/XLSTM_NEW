...
# Experiment 10: 3D Chunk + Hard Negative Selection
...
echo "=========================================="
echo "Experiment 10: 3D Chunk + Hard Negative Selection"
echo "=========================================="
...
OUTPUT_DIR="$BASE_DIR/nnUNet_predictions/exp10_3D_chunk_hard_negative"
