...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, learning_rate: float, batchsize: int, unpack_dataset: bool = True,
    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            # self.load_checkpoint('/home/ubuntu/public_c/crl/cchenzong/U-Mamba/data/nnUNet_results/Dataset702_AbdomenMR/nnUNetTrainerUMambaEnc__nnUNetPlans__3d_fullres/fold_all_lr5e-3_amp/checkpoint_1939.pth')
        else:
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.SGD(self.network.parameters(), 0.00611, weight_decay=self.weight_decay,
